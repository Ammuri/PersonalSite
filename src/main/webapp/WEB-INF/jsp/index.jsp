...
<head>
    ...
    <title>Omar Abdelati's Personal Site</title> 
</head>

<body>
    <div class="container-fluid">
        <h1 class="display-1 text-center">You've been had!</h1>
        <br>
    </div>
    <div>
        <img src="https://www.memecreator.org/static/images/memes/3871073.jpg" class="rounded mx-auto d-block" alt="Sorry... I gotcha this time.">
        <br>
    </div>
